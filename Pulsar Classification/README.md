...
pulsar, as determined by the length of an observation.

In the absence of additional info, each
...
# The Classifier
The Classifier uses Random Forest Classifier to predict whether an observation is really a Pulsar star or not.
Various Classifiers were used but finally I settled on the Random Forest Classiifer after comparing the score
